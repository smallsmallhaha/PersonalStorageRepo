...
%      dcm = angle2dcm( pitch, roll, yaw, 'YXZ' )
	...
	\begin{equation}
	d_{\epsilon} =
	\frac{|(\vecba{p p_1} \times \vecba{p p_2}) \cdot \vecba{p p_3}|}{3|S_{p_1 p_2 p_3}|}
	\end{equation}
	用李代数表示如下
	\begin{equation}
	\vecba{d_{\epsilon}} =
	\frac{(p_3-e(\xi ^\wedge)p)^{+}((p_1-e(\xi ^\wedge)p)^\wedge(p_2-e(\xi ^\wedge)p))}{3|S_{p_1 p_2 p_3}|}
	\end{equation}
	...
	\begin{equation}
	\vecba{d_{\epsilon}} =
	\frac{(p_3-p_1)^{+}(p_2-p_1)^\wedge(e(\xi ^\wedge)p-p_1)}{3|S_{p_1 p_2 p_3}|}
	\end{equation}
	\begin{equation}
	\frac{\partial \vecba{d_{\epsilon}}}{\partial\delta\xi}
	=
	\frac{(p_3-p_1)^{+}(p_2-p_1)^\wedge(e(\xi ^\wedge)p)^\odot}{3|S_{p_1 p_2 p_3}|}
	\end{equation}
